...
- **Locators Directory:** Contains pages's locators objects corresponding to the application's UI pages.
- **Element Directory:** Contains elements, like buton etc, you can meeting in app.
...
- Node.js (v20.19.5) and npm (10.2.3)
- Android SDK
